      ...
      for i in range(COUNT):
        ...
        with conn.transaction():
          ...
          cur.execute("""
            ...
            VALUES (%s, %s, %s, %s, %s)
          """, (ticket_no, book_ref, f'warm{i:05d}', 'Warm', True,))
          ...
          cur.execute("DELETE FROM bookings.tickets WHERE ticket_no = %s", (ticket_no,))
          cur.execute("DELETE FROM bookings.bookings WHERE book_ref = %s", (book_ref,))
